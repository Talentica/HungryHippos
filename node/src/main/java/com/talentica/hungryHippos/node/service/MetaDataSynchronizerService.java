  ...
  public void run() {
    ...
    try {
      ...
      String dataFolderPath =
          baseFolderPath + File.separator + FileSystemContext.getDataFilePrefix();
      File dataFolder = new File(dataFolderPath);
      String[] files = dataFolder.list();
      String metadataFilePath = baseFolderPath + File.separator
          + FileSystemConstants.META_DATA_FOLDER_NAME + File.separator + NodeInfo.INSTANCE.getId();
      MetaDataSynchronizer.INSTANCE.synchronize(dataFolderPath, files, dataFolderPath,
          metadataFilePath, hhFilePath);
