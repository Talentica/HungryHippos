...
echo "adding hduser identity"
ssh-add $PRIVATE_KEY_PATH
echo "added hduser identity"
...
do
     ...
     #   fi
        ...
        do
              ...
              ssh -o StrictHostKeyChecking=no  hduser@$i "cd $distrOutputPath/$k  && find -type f -maxdepth 5 -size +0 -not -path '*/\.*' -exec cat {} +" >> $downloadLoc/$jobDir/$k/result-$i.txt
