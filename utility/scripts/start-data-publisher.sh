...
do
   ...
   ssh -o StrictHostKeyChecking=no root@$node "cd hungryhippos/data-publisher;java -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=./ -cp data-publisher.jar com.talentica.hungryHippos.master.DataPublisherStarter $jobUuid $dataparserclass> ./system.out 2>./system.err &"
done
