...
2. vagrant.properties has following variables with default values
   ...
   2.5 TOKEN=*********************** //token id by which you can access digital ocean api. #for more details refer #Token Generation
...
3. copy node/build/lib/node.jar to the distr_original/lib 
4. execute ./vagrant_init_caller.sh
   
5. to destroy the nodes execute ./destroy-node.sh
