...
public class ReplicaDataSender extends Thread {
    ...
    public enum Status {SENDING_BLOCK, ENABLE_BLOCK_WRITE, ENABLE_BLOCK_READ}
    private Status[] memoryBlockStatus;

    public ReplicaDataSender(String nodeIp, int port, String destinationPath, byte[][] memoryBlocks) throws IOException {
    ...
    private void establishConnection(String nodeIp, int port) throws IOException {
        ...
        int noOfAttemptsToConnectToNode = 25;
        while (true) {
            try {
