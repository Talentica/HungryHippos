...
public class OrcDataMerger implements Callable<Boolean> {

    private volatile boolean alive = true;

    private Queue<OrcStoreIncrementalDataEntity> mergeDataEntities;

    public OrcDataMerger(Queue<OrcStoreIncrementalDataEntity> mergeDataEntities) {
    ...
    public Boolean call() throws Exception {
        ...
        while (alive){
            ...
            if(dataEntity!=null){
                ...
                OrcFileMerger.mergeFiles(new Path(dataEntity.getDestPath()),pathList,true,false);
            }else {
                Thread.sleep(1000);
            }
        }
