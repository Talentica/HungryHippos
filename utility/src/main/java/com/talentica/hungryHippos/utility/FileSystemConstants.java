...
public interface FileSystemConstants {
	...
	String CLIENT_UPLOADS_IN_PARALLEL = "CLIENT_UPLOADS_IN_PARALLEL";
	String META_DATA_FOLDER_NAME = "METADATA";
	String FILE_STATISTICS_FOLDER_NAME = "FILE_STATISTICS";
	String BLOCK_STATISTICS_FOLDER_NAME = "BLOCK_STATISTICS";
