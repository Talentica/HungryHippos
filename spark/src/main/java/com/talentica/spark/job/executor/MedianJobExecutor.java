...
public class MedianJobExecutor {
    ...
    public static JavaRDD<Tuple2<String, Double>> process(HHRDD hipposRDD, Broadcast<FieldTypeArrayDataDescription> descriptionBroadcast,
        ...
        JavaRDD<Tuple2<String, Double>> resultRDD = pairRDD.mapPartitions(new FlatMapFunction<Iterator<Tuple2<String, Integer>>, Tuple2<String, Double>>() {
            @Override
            public Iterator<Tuple2<String, Double>> call(Iterator<Tuple2<String, Integer>> t) throws Exception {
