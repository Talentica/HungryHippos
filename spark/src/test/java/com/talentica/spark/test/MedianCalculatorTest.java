...
public class MedianCalculatorTest {
	...
	public void testSingle() {
		MedianCalculator<Integer> avlTree = new MedianCalculator<Integer>(new Integer[] { 1 });
		Assert.assertEquals(1.0, avlTree.getMedian(), DELTA);
	}

	@Test
	public void testTwoOnlyRight() {
		MedianCalculator<Integer> avlTree = new MedianCalculator<Integer>(new Integer[] { 5, 7 });
		Assert.assertEquals(6.0, avlTree.getMedian(), DELTA);
	}

	@Test
	public void testOddWithDuplicate() {
		MedianCalculator<Integer> avlTree = new MedianCalculator<Integer>(new Integer[] { 5, 4, 3, 2, 1, 4, 3 });
		Assert.assertEquals(3, avlTree.getMedian(), DELTA);
	}

	@Test
	public void testOddWithoutDuplicate() {
		MedianCalculator<Integer> avlTree = new MedianCalculator<Integer>(new Integer[] { 5, 4, 3, 2, 1 });
		Assert.assertEquals(3, avlTree.getMedian(), DELTA);
	}

	@Test
	public void testEvenWithDuplicate() {
		MedianCalculator<Integer> avlTree = new MedianCalculator<Integer>(new Integer[] { 5, 2, 5, 5, 2, 3 });
		Assert.assertEquals(4.0, avlTree.getMedian(), DELTA);
	}

	@Test
	public void testEvenWithoutDuplicate() {
		MedianCalculator<Integer> avlTree = new MedianCalculator<Integer>(new Integer[] { 10, 100, 45, 1, 8, 15 });
	...
	public void testSecondRandom() {
		MedianCalculator<Integer> avlTree = new MedianCalculator<Integer>(new Integer[] { 1, 2, 50, 3, 4, 30, 2, 3 });
		Assert.assertEquals(3, avlTree.getMedian(), DELTA);
	}
