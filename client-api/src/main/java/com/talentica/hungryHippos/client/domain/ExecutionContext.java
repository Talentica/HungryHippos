...
/**
 * This interface is used to perform various operation on each of the records of the data set
 * provided.
 * 
 * @author debasishc.
 * @since 2015-09-09
...
public interface ExecutionContext {
  ...
  /**
   * Method is used to get the value at particular index of the record of data set.
   * 
   * @param index is the position of the particular value.
   * @return an object at specified index
   */
  ...
  /**
   * To save the value of index or column of records after aggregation are completed
   * 
   * @param calculationIndex is index on which aggregation is performed.
   * @param value is the value computed value after aggregation.
   */
   ...
   * @param calculationIndex is index on which aggregation is performed.
   * @param value is the value computed value after aggregation.
   * @param metric name of the matrix such as sum, median etc.
   */
   ...
   * To save the value of index or column of records after aggregation are completed.
   * 
   * @param jobId represents the job id which did this calculation.
   * @param calculationIndex is index on which aggregation is performed.
   * @param value is the value computed value after aggregation.
   * @param metric name of the matrix such as sum, median etc.
   */
   ...
   * 
   * @param valueSet Key-index and value pair.
   */
  ...
  /**
   * Flushes the output stream associated and forces any buffered output bytes to be written out.
   */
  void flush();
}
