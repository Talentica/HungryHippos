...
public class DataRetrieverClient {
    ...
    public static void getHungryHippoData(String fileZKNode, String outputDirName, int dimension) throws Exception {
        ...
        String fileNodeZKPath = CoordinationApplicationContext.getZkProperty().getValueByKey(FileSystemConstants.ROOT_NODE) +
        ...
        for (String nodeIp : nodeIps) {
            ...
            retrieveDataBlocks(nodeIp, fileZKNode, dataBlocks.toString(), outputDirName + File.separator + FileSystemConstants.DOWNLOAD_FILE_PREFIX + count++, dataSize);
        }
    }
     ...
     */
    public static void retrieveDataBlocks(String nodeIp, String fileZKNode, String dataBlocks, String outputFile, int fileStreamBufferSize, long dataSize, int port, long retryTimeInterval, int maxQueryAttempts) {
        int i = 0;
