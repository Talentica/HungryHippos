...
insert into `hungryhippos_tester`.`process_instance` values(1,5,1);
insert into `hungryhippos_tester`.`process_instance` values(2,5,1);
...
insert into `hungryhippos_tester`.`process_instance_detail` values(3,1,1,'172.54.34.31','COMPLETED',STR_TO_DATE('2/15/2016 8:06:26 AM', '%c/%e/%Y %r'),now(),null);
