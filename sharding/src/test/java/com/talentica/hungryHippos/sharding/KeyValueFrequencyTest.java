...
public class KeyValueFrequencyTest {
	...
	public void testEquals() {
		...
		MutableCharArrayString mutableCharArrayStringL1 = new MutableCharArrayString(byteBuffer1);
		...
		MutableCharArrayString mutableCharArrayStringL2 = new MutableCharArrayString(byteBuffer2);
