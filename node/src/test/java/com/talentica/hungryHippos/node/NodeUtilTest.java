...
public class NodeUtilTest {
	...
	private Map<BucketCombination, Set<Node>> bucketCombinationToNodeNumbersMap = new HashMap<BucketCombination, Set<Node>>();
	private Map<String, Map<Object, Bucket<KeyValueFrequency>>> keyToValueToBucketMap = new HashMap<String, Map<Object, Bucket<KeyValueFrequency>>>();
	private Map<String, Map<Bucket<KeyValueFrequency>, Node>> bucketToNodeNumberMap = new HashMap<String, Map<Bucket<KeyValueFrequency>, Node>>();
