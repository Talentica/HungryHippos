...
public class NodeUtil {
	...
	/*
	 * static { ShardingTableCache shardingTableCache =
	 * ShardingTableCache.newInstance(); keyToValueToBucketMap = (Map<String,
	 * Map<Object, Bucket<KeyValueFrequency>>>) shardingTableCache
	 * .getShardingTableFromCache(
	 * ShardingTableFilesName.KEY_TO_VALUE_TO_BUCKET_MAP_FILE.getName());
	 * bucketToNodeNumberMap = (Map<String, Map<Bucket<KeyValueFrequency>,
	 * Node>>) shardingTableCache
	 * .getShardingTableFromCache(ShardingTableFilesName.
	 * BUCKET_TO_NODE_NUMBER_MAP_FILE.getName()); }
	 */
	...
	public static final Map<String, Map<Bucket<KeyValueFrequency>, Node>> getBucketToNodeNumberMap() {
		// added by sudarshan
		ShardingTableZkService zkservice = new ShardingTableZkService();
		bucketToNodeNumberMap = zkservice.getBucketToNodeNumberMap();
