...
do
   ...
   sshpass -p $node_pwd ssh root@$node "cd hungryhippos/data-publisher;rm datapublisher.log*;rm bucketToNodeNumberMap;rm bucketCombinationToNodeNumbersMap;rm keyToValueToBucketMap"
done
