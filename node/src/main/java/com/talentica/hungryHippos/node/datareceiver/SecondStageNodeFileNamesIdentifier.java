...
public class SecondStageNodeFileNamesIdentifier {
    ...
    public SecondStageNodeFileNamesIdentifier(String[] keyOrder, HashMap<String, HashMap<Bucket<KeyValueFrequency>, Node>> bucketToNodeNumberMap, int maxBucketSize, int fileId, int reduceFactor) {
