...
public class HHRDDHelper {
  ...
  public static void initialize(String clientConfigPath) throws JAXBException, FileNotFoundException {
    ...
    public static HHRDDInfo getHhrddInfo(String distributedPath) throws JAXBException, FileNotFoundException {
        ...
        HHRDDInfo hhrddInfo = new HHRDDInfo(ShardingFileUtil.readFromFileBucketCombinationToNodeNumber(bucketCombinationToNodeNumbersMapFilePath),
