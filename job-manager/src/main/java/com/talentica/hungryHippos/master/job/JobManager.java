...
public class JobManager {
	...
	public void start(String jobUUId) throws Exception {
		...
		getFinishNodeJobsSignal(CommonUtil.ZKJobNodeEnum.FINISH_JOB_MATRIX
				.name());
		LOGGER.info("\n\n\n\t FINISHED!\n\n\n");
	...
	private Map<Integer, Node> getNodeIdNodesMap() {
		...
		for (String key : bucketToNodeNumberMap.keySet()) {
			Map<Bucket<KeyValueFrequency>, Node> bucketsToNodeMap = bucketToNodeNumberMap
					.get(key);
	 ...
	 */
	private void sendJobsToNodes(String jobUUId) throws ClassNotFoundException,
