...
do
   ...
   sshpass -p $node_pwd ssh root@$node "cd hungryhippos/manager;nohup java -Xms512m -Xmx900m -cp master.jar:test-jobs.jar com.talentica.hungryHippos.manager.main.MasterStarter $1 &"
done
