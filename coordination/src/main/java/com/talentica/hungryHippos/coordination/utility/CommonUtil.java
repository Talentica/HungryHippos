...
public class CommonUtil {
  ...
  public static void loadDefaultPath(String jobUUIdFolderName) {
    ...
    if (OSValidator.isWindows()) {
      TEMP_JOBUUID_FOLDER_PATH =
          Paths.get("../" + jobUUIdFolderName).toAbsolutePath().toString()
  ...
  public enum ZKJobNodeEnum {
    ...
    PUSH_JOB_NOTIFICATION("PUSH_JOB"), PULL_JOB_NOTIFICATION("PULL_JOB"), START_ROW_COUNT(
        ...
        "DATA_PUBLISHING_COMPLETED"), START_NODE_FOR_DATA_RECIEVER("START_NODE_FOR_DATA_RECIEVER"), SAMPLING_COMPLETED(
        "SAMPLING_COMPLETED"), INPUT_DOWNLOAD_COMPLETED("INPUT_DOWNLOAD_COMPLETED"), SHARDING_FAILED(
        "SHARDING_FAILED"), DATA_PUBLISHING_FAILED("DATA_PUBLISHING_FAILED"), FINISH_JOB_FAILED(
        ...
        "OUTPUT_FILES_ZIPPED_AND_TRANSFERRED"), DROP_DROPLETS("DROP_DROPLETS"), ERROR_ENCOUNTERED(
        "ERROR_ENCOUNTERED");
