...
public class CommonUtil {
	...
	public enum ZKJobNodeEnum{
		...
		PUSH_TASK_NOTIFICATION("PUSH_TASK"),PULL_JOB_NOTIFICATION("PULL_JOB"),START_ROW_COUNT("START_ROW_COUNT"),START_JOB_MATRIX("START_JOB_MATRIX"),FINISH_JOB_MATRIX("FINISH_JOB_MATRIX"),FINISH_ROW_COUNT("FINISH_ROW_COUNT");
