...
public class JobManagerStarter {
  ...
  public static void main(String[] args) {
    try {
      ...
      JobManager.nodesManager = CoordinationApplicationContext.getNodesManagerIntances();
  ...
  private static void validateProgramArguments(String[] args) throws InstantiationException,
    ...
    if (args.length < 2) {
      System.out
          .println("Please provide the required jobn matrix class name  as 1st argument to be able to run the program and 2nd argument as jobuuid.");
      System.exit(1);
    }
