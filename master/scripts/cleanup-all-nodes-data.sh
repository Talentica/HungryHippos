...
do
   ...
   sshpass -p $node_pwd ssh root@$node "cd hungryhippos;rm ./data/Application.log*;rm ./data/data_*;rm Application.log*;rm outputFile;rm bucketToNodeNumberMap;rm keyToValueToBucketMap"
done
