...
do
	...
	sshpass -p $node_pwd ssh root@$1 "cd hungryhippos;nohup java -cp node.jar:test-jobs.jar com.talentica.hungryHippos.manager.node.NodeStarter ./config.properties &"
done
