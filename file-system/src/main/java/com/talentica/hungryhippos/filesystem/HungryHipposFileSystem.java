...
public class HungryHipposFileSystem {
	...
	public String createZnode(String name, CountDownLatch signal) {
		name = checkNameContainsFileSystemRoot(name);
		return createZnode(name, signal, null);
	}
	 ...
	 * @throws Exception
	 */
	public void updateFSBlockMetaData(String fileZKNode, String nodeIp, String dataFileZKNode, long datafileSize)
			throws Exception {

		String fileNodeZKPath = HUNGRYHIPPOS_FS_ROOT_ZOOKEEPER + File.separator + fileZKNode;
