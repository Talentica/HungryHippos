...
public class FileDataRetriever {
    ...
    /**
     * This method is for reading the metadata from the zookeeper node and retrieving the data on a particular dimension
     *
     * @param fileZKNode
     * @param outputDirName
     ...
     * @throws Exception
     */
    public static void retrieveZookeeperData(String fileZKNode, String outputDirName, int noOfAttempts, int dimension) throws Exception {
        ...
        for (String nodeIp : nodeIps) {
            ...
            for (String dataFileNode : datafileNodes) {
                ...
                if ((dataFileNodeInt & binaryDimensionOperand) == binaryDimensionOperand) {
                    ...
                    String nodeDataString = (String) nodesManager.getObjectFromZKNode(fileZKNode + File.separator + nodeIp + File.separator + dataFileNode);
            ...
            requestDataFile(nodeIp, dataFilePaths.toString(), outputDirName + File.separator + "part-" + count++, noOfAttempts);
        }
    }
     ...
     */
    public static void requestDataFile(String nodeIp, String dataFilePaths, String outputFile, int noOfAttemptsLeft) {
        noOfAttemptsLeft--;
    ...
    public static void main(String[] args) throws Exception {
        int dimension = 1;
        retrieveZookeeperData("/filesystem/input", "/home/rajkishoreh/hungryhips/inp_" + Thread.currentThread().getId(), MAX_NO_OF_ATTEMPTS, dimension);
        ...
        /*for (int i = 0; i < 25; i++) {
            new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        retrieveZookeeperData("/filesystem/input", "/home/rajkishoreh/hungryhips/inp_" + Thread.currentThread().getId(), MAX_NO_OF_ATTEMPTS);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
