...
/**
 * This is a class for uploading the filesystem configuration xml in the zookeeper Created by
 * rajkishoreh on 8/7/16.
 */
public class FileSystemStarter {
  private static final Logger LOGGER = LoggerFactory.getLogger(FileSystemStarter.class);

  /**
   * This is the main method for uploading the file system configuration. Takes path to the
   * filesystem configuration xml as argument
   * 
   * @param args
   */
  public static void main(String[] args) throws Exception {
    try {
      ...
      if (configuration.getServerPort() == 0 || configuration.getFileStreamBufferSize() <= 0
          ...
          || configuration.getRootDirectory() == null
          || "".equals(configuration.getDataFilePrefix())
