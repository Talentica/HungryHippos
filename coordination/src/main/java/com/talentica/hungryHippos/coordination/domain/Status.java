...
/**
 * 
 * {@code Status} for creating failure and success status.
 * 
 * @author PooshanS
 *
 */
public class Status {
   ...
   *
   * @param detail more information, if necessary: can be @code{null}, in which case simply "Ok"
   *        will be used
   ...
   *
   * @param throwable whose @link{Throwable#getLocalizedMessage} will be used to create the error
   *        detail
