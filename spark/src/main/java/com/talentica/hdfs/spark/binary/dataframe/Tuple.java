...
public class Tuple extends AbstractTuple {
  ...
  public Tuple(FieldTypeArrayDataDescription dataDescription) {
  ...
  @Override
  protected void doDataTypeValidation() throws NoSuchFieldException, SecurityException {
    defaultValidation(Tuple.class);
  }
}
